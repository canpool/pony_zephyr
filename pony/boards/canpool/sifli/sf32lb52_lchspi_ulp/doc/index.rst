.. zephyr:board:: sf32lb52_lchspi_ulp

Overview
********

SF32LB52-LCHSPI-ULP is a development board based on the SF32LB52x series chip
...
`SF32LB52-LCHSPI-ULP website`_.

Hardware
********

SF32LB52-LCHSPI-ULP provides the following hardware components:
...
.. _SF32LB52-LCHSPI-ULP website:
   https://wiki.lckfb.com/zh-hans/hspi-sf32lb52/lckfb-hspi-sf32lb52/index.html
