.. _st_mb1835b_lcd_touch:

ST MB1835B LCD with TOUCH
#########################
...
``st_mb1835b_lcd_touch`` and adding the necessary device tree properties.

Set ``--shield "st_mb1835b_lcd_touch"`` when you invoke ``west build``. For example:

.. zephyr-app-commands::
   :zephyr-app: samples/drivers/display
   :board: stm32u5a9j_dk
   :shield: st_mb1835b_lcd_touch
   :goals: build
